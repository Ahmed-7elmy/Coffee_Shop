...
import com.example.myjava.databinding.ViewholderItemPicLeftBinding
import com.example.myjava.databinding.ViewholderItemPicRightBinding

class ItemsListCategoryAdapter( val items: List<ItemsModel>):
        ...
        fun bindCommonData(
            ...
            when (holder) {
                is ViewHolderITem1 -> {
                    ...
                    holder.binding.picMain.setOnClickListener {
